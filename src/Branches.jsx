        ...
        return (
            <div className="relative bottom-0 ">
                ...
                <ul className="list-decimal ml-4 md:columns-2">
                    <li>
                        {props.default} <span className="py-0.5 px-1.5 rounded-md bg-stone-200">Default Branch</span>
                    </li>
                        ...
                        <li className="list-none flex gap-5">
                            {showBranchNumber < data.length ? (
                                <div
                                    ...
                                    className="hover:text-purple-600 cursor-pointer w-min font-semibold">
                                    More...
                                </div>
                            ) : (
                                ''
